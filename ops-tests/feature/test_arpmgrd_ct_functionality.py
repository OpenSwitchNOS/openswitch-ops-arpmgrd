...
def arp_manager_ovsdb_update(sw1, h1, h2):
    ...
    h1('ping6 -c 2 2000::1')
    h2('ping6 -c 2 2002::1')
    h1.libs.ping.ping(2, "192.168.1.1")
    h2.libs.ping.ping(2, "192.168.2.1")
    output = sw1("show arp")
...
def arp_manager_neighbor_fail(sw1, h1, h2):
    ...
    print("Address deleted. Waiting for 60 seconds "
